        ...
        topBar = {
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                CenterAlignedTopAppBar(
                    title = {
                        Text(if (screen == M7Screen.NOTES) "Notes App Danar" else "Settings")
                    }
                )
            }
        },
...
private fun NotesContent(
    ...
    Column(
        ...
        when {
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            Text("Gemini sedang merangkum catatan", fontWeight = FontWeight.SemiBold)
                            Text(
                                "Tunggu sebentar, ringkasan akan muncul di bawah.",
            ...
            !uiState.aiSummary.isNullOrBlank() -> {
                Card(
                    modifier = Modifier.fillMaxWidth(),
                    colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surfaceVariant)
                ) {
                    Column(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                Text("Ringkasan AI", fontWeight = FontWeight.Bold)
                                Text(
                                    uiState.aiSummaryTitle.orEmpty(),
                                    style = MaterialTheme.typography.bodySmall,
                                    color = MaterialTheme.colorScheme.onSurfaceVariant
                                )
                            }
                        ...
                        Text(uiState.aiSummary.orEmpty())

                        Button(onClick = onClearAiSummary) {
                            Text("Tutup ringkasan")
                        }
                    }
                }
